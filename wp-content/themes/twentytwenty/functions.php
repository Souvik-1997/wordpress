...
class Foo_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		$desc = ! empty( $instance['desc'] ) ? $instance['desc'] : esc_html__( 'Small decription', 'text_domain' ); 
		?>
		<p>
		...
		<textarea cols="30" rows="5" class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'desc' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'desc' ) ); ?>"><?php echo esc_attr( $desc ); ?> </textarea>
		</p>
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'desc' ) ); ?>"><?php esc_attr_e( 'Description:', 'text_domain' ); ?></label> 
